...
function customizer_library_vogue_options() {
    ...
    $options['vogue-upsell-layout'] = array(
        ...
        'section' => $section,
        'type'    => 'upsell',
        'description' => __( '<b>Premium Extra Features:</b><br />- Site Boxed / Full Width layouts<br />- Set website container width<br />- Set page sidebar width<br />- Remove Page Titles<br />- Page Featured Image displayed as full width banner<br />- Set WooCommerce Shop, Archives & Product pages to full width<br />- Remove WooCommerce product borders<br />- Set how many Shop products show per row<br />- Set how many Shop products show per row', 'vogue' )
    );
